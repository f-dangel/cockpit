...
def _format(self, ax_all, ax_norm, ax_inner, ax_ortho):
    ...
    ax_all.set_facecolor(self.color_summary_plots)

    ax_norm.set_ylabel("norm")
    ax_norm.set_ylim([0, 1])
    ax_norm.xaxis.tick_top()
    ax_norm.set_facecolor(self.color_summary_plots)

    ax_inner.set_ylabel("inner")
    ax_inner.set_ylim([0, 1])
    ax_inner.invert_yaxis()
    ax_inner.set_facecolor(self.color_summary_plots)
    ...
    ax_ortho.set_facecolor(self.color_summary_plots)
